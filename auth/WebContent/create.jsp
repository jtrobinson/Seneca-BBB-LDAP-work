...
<form action="createAction.jsp" method="post" name="form">
	<div id='container' width='465'>
		<div id='row'><h4> Create Session</h4></div>
			<% 
				String checked = ""; 
     	...
     	<div id='row'>
	     	<div id='left'>
	     		Moderator Password <span style='color:red'>*</span>
	     	</div>
	     	<div id='right'>   
	     		<input type="text" id="mPwd" name="mPwd"
					<% if(session.getAttribute( "mPwd" ) != null) out.print("value = '"+session.getAttribute("mPwd")+"'"); %>
				/>
			</div>
	   	</div>
	    <div id='row' >
	     	...
	     	<div id='right'>
	     		<input type="text" id="mPwdre"  name="mPwdre" 
	      			<% if(session.getAttribute( "mPwdre" ) != null) out.print("value = '"+session.getAttribute("mPwdre")+"'"); %>
	      		/>
	      	</div>		
     	</div>
     	<div id='row'>
     		...
     		<div id='right'>      
     			<input type="text" id="vPwd" name="vPwd"  
     				<% if(session.getAttribute( "vPwd" ) != null) out.print("value = '"+session.getAttribute("vPwd")+"'"); %>
     			/>
     		</div>
     	</div>
     	<div id='row'>
     		...
     		<div id='right'>   
     			<input type="text" id="vPwdre" name="vPwdre"  
     				<% if(session.getAttribute( "vPwdre" ) != null) out.print("value = '"+session.getAttribute("vPwdre")+"'"); %>
     			/>
     		</div>
     	</div>
     ...
     <div id='container'>	
     	<div id='row' height='60' vertical-align='middle'>
     		<div id='error'>
	           	<%
